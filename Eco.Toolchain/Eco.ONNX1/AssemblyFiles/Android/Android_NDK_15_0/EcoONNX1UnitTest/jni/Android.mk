...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/lib6CFEE7807C744D9BA4FFA3F1E6599735.a 
include $(PREBUILT_STATIC_LIBRARY)
########################
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoONNX1.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoONNX1UnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 6CFEE7807C744D9BA4FFA3F1E6599735
