...
########################
# prepare Eco.AI.Engine1
include $(CLEAR_VARS)
LOCAL_MODULE    := lib6E5C5B7C979F40108F7CDC08EADFB777
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/lib6E5C5B7C979F40108F7CDC08EADFB777.a 
include $(PREBUILT_STATIC_LIBRARY)
########################

#
# EcoAIEngine1UnitTest
#
include $(CLEAR_VARS)
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoAIEngine1.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoAIEngine1UnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 6E5C5B7C979F40108F7CDC08EADFB777
