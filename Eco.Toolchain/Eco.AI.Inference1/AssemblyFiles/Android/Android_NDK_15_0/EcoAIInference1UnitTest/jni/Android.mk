...
########################
# prepare Eco.AI.Inference1
include $(CLEAR_VARS)
LOCAL_MODULE    := libC5519906D88D49E9BC8AE817D82986D3
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../BuildFiles/Android/$(TARGET_ARCH_ABI)/StaticRelease/libC5519906D88D49E9BC8AE817D82986D3.a 
include $(PREBUILT_STATIC_LIBRARY)
########################

#
# EcoAIInference1UnitTest
#
include $(CLEAR_VARS)
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../../UnitTestFiles/SourceFiles/EcoAIInference1.c

ifeq ($(TARGET_LINK),0)

LOCAL_MODULE := EcoAIInference1UnitTest
...
LOCAL_STATIC_LIBRARIES := 00000000000000000000000000000100 00000000000000000000000042757331 0000000000000000000000004D656D31 00000000000000000000000046534D31 C5519906D88D49E9BC8AE817D82986D3
