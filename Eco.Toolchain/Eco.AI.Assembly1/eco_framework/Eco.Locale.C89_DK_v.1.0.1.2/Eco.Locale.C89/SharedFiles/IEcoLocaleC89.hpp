...
#ifndef __I_ECO_LOCALE_C89_HPP__
#define __I_ECO_LOCALE_C89_HPP__
...
interface IEcoLocaleC89 : public IEcoUnknown {
public:
    /* IEcoLocaleC89 */
    virtual char* ECOCALLMETHOD setlocale(/* in */ int category, /* in */ const char *locale) = 0;
    virtual struct lconv* ECOCALLMETHOD localeconv(/* in */ void) = 0;

};

#endif /* __I_ECO_LOCALE_C89_HPP__ */
