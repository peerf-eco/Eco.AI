...
#ifndef __I_ECO_SOCKET_POSIX_2002_HPP__
#define __I_ECO_SOCKET_POSIX_2002_HPP__
...
interface IEcoINetP02: public IEcoUnknown {
public:
    /* IEcoINetP02 */
    virtual uint32_t ECOCALLMETHOD htonl(uint32_t) = 0;
    virtual uint16_t ECOCALLMETHOD htons(uint16_t) = 0;
    virtual uint32_t ECOCALLMETHOD ntohl(uint32_t) = 0;
    virtual uint16_t ECOCALLMETHOD ntohs(uint16_t) = 0;
    virtual in_addr_t ECOCALLMETHOD inet_addr(const char *) = 0;
    virtual char* ECOCALLMETHOD inet_ntoa(struct in_addr) = 0;
    virtual const char* ECOCALLMETHOD inet_ntop(int, const void* /* restrict */, char* /* restrict */, socklen_t) = 0;
    virtual int ECOCALLMETHOD inet_pton(int, const char* /* restrict */, void* /* restrict */) = 0;
};
...
interface IEcoSocketP02 : public IEcoUnknown {
public:
    /* IEcoSocketP02 */
    virtual int ECOCALLMETHOD accept(int, struct sockaddr *, socklen_t *) = 0;
    virtual int ECOCALLMETHOD bind(int, const struct sockaddr *, socklen_t) = 0;
    virtual int ECOCALLMETHOD connect(int, const struct sockaddr *, socklen_t) = 0;
    virtual int ECOCALLMETHOD getpeername(int, struct sockaddr *, socklen_t *) = 0;
    virtual int ECOCALLMETHOD getsockname(int, struct sockaddr *, socklen_t *) = 0;
    virtual int ECOCALLMETHOD getsockopt(int, int, int, void *, socklen_t *) = 0;
    virtual int ECOCALLMETHOD listen(int, int) = 0;
    virtual ssize_t ECOCALLMETHOD recv(int, void *, size_t, int) = 0;
    virtual ssize_t ECOCALLMETHOD recvfrom(int, void *, size_t, int, struct sockaddr *, socklen_t *) = 0;
    virtual ssize_t ECOCALLMETHOD recvmsg(int, struct msghdr *, int) = 0;
    virtual int ECOCALLMETHOD recvmmsg(int, struct mmsghdr *, unsigned int, int, struct timespec *) = 0;
    virtual ssize_t ECOCALLMETHOD send(int, const void *, size_t, int) = 0;
    virtual ssize_t ECOCALLMETHOD sendto(int, const void *, size_t, int, const struct sockaddr *, socklen_t) = 0;
    virtual ssize_t ECOCALLMETHOD sendmsg(int, const struct msghdr *, int) = 0;
    virtual int ECOCALLMETHOD sendmmsg(int, struct mmsghdr *, unsigned int, int) = 0;
    virtual int ECOCALLMETHOD setsockopt(int, int, int, const void *, socklen_t) = 0;
    virtual int ECOCALLMETHOD shutdown(int, int) = 0;
    virtual int ECOCALLMETHOD sockatmark(int) = 0;
    virtual int ECOCALLMETHOD socket(int, int, int) = 0;
    virtual int ECOCALLMETHOD socketpair(int, int, int, int *) = 0;
};

#endif /* __I_ECO_SOCKET_POSIX_2002_HPP__ */
